...
I added <strong>sample_validation.py</strong>
...
```
You may find that the data images in validation group is less than 20 (Tried this on Sep, 2020). So I think it is convenient to download all the data images in train, using
```bash
